...
const STRINGS = {
  en: {
    ...
    SHIPMENT_ALREADY_EXISTS: "This order already has an active shipment. Cancel it before booking another.",
  ...
  ar: {
    ...
    SHIPMENT_ALREADY_EXISTS: "يوجد لهذا الأوردر شحنة نشطة بالفعل. ألغِها قبل حجز شحنة أخرى.",
